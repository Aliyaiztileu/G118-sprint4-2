...
<%
    String passworsError = request.getParameter("passwordError");
    if (passworsError!=null){
%>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="user_repassword" type="password" class="form-control" id="exampleInputPassword13">
                    </div>
                    <div class="mb-3">
